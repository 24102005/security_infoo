...
### __This should give you a solid foundation to build upon!  
Let me know if you have any specific questions about parts of the code or want to explore any of these enhancements or contribute: [Let's Connect](#lets-connect).

## Made with love and Manus AI
This tutorial has parts and was made with the help of AI.   

>[!WARNING]  
>The AI used for creating the codes was Manus AI and the code was review by human (not vibe code but AI-assisted)
